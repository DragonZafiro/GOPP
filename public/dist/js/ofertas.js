...
var tableProduct = $('#products-table').DataTable({
    ...
    "language": {
        ...
        "zeroRecords": "<h5>No se han encontrado ofertas o promociones</h5>",
        "info": "Mostrando página _PAGE_ de _PAGES_",
        "infoEmpty": "<h4>Agrega una nueva oferta!</h4>",
        "infoFiltered": "(Filtrado de _MAX_ registros totales)",
        "sSearch": "Buscar"
    },
    ajax: "ofertas_promociones",
    columns: [
        {
            data: 'foto', name: 'foto',
        ...
        { data: 'compraMinima', name: 'compraMinima' },
        { data: 'encabezado', name: 'encabezado' },
