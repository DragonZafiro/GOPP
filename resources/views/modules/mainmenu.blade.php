...
@else
    <li><a href="#"><span class="fa fa-tags"></span>Promos</a></li>
    <li><a href="#"><span class="fas fa-thumbtack"></span>Categorías</a></li>
    <li><a href="#"><span class="fa fa-building"></span>Empresas</a></li>
    <li><a href="#"><span class="fa fa-bicycle"></span>Reparto</a></li>
    <li><a href="#"><span class="fas fa-map-marker-alt"></span>Mapa</a></li>
    <li><a href="#"><span class="fas fa-ticket-alt"></i></span>Puntos</a></li>
    <li><a href="#"><span class="fa fa-envelope"></i></span>Notificaciones</a></li>
    <li><a href="#"><span class="fa fa-question-circle"></i></span>...</a></li>
@endif
