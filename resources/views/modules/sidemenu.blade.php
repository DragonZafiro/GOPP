...
@if(!auth()->guest())
    ...
    @endif
@else
    <a href="#"><li><span class="fa fa-home"></span>Inicio</li></a>
    <a href="#"><li><span class="fa fa-user"></span>Mi Cuenta</li></a>
    <a href="#"><li><span class="fas fa-ticket-alt"></span>Mis Puntos</li></a>
    <a href="#"><li><span class="fa fa-truck"></span>Mis Pedidos</li></a>
    <a href="#"><li><span class="fa fa-envelope"></span>Guardados</li></a>
    <a href="#"><li><span class="fa fa-industry"></span>Factura</li></a>
    <a href="#"><li><span class="fas fa-magic"></span>Lo que quieras</li></a>
    <a href="#"><li><span class="fas fa-box-open"></span>Favor</li></a>
    <a href="#"><li><span class="fas fa-share-alt-square"></span>Comparte y Gana!</li></a>
    <a href="#"><li class="text-praemie"><span class="fa fa-rocket"></span>Praemie</li></a>
    <a href="#"><li><span class="fa fa-eye"></span>Acerca de...</li></a>
    <a href="#"><li><span class="fas fa-power-off"></span>Cambiar Sesión</li></a>
@endif
