...
class BoletinController extends Controller
{
    ...
    public function AllBoletin()
    {
        $id = intval(Auth::user()->loggedAsBusiness);
        $boletin = Boletin::where('business_id', $id)->get();
        return Datatables::of($boletin)
            ->addColumn('action', function ($boletin) {
                $buttons = ' <a onclick="editForm(' . $boletin->id . ')" class="btn btn-sm btn-info text-white"><i class="fas fa-edit"></i></a>' .
                    ' <a onclick="deleteData(' . $boletin->id . ')" class="btn btn-sm btn-danger text-white"><i class="fas fa-times"></i></a>';
                return $buttons;
            })
            ->make(true);
    }
